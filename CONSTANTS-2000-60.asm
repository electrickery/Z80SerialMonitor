...
UART_1DAT:  EQU    060h         ; 1st channel data port
UART_1CTL:  EQU    062h         ; 1st channel control port
UART_2DAT:  EQU    061h         ; 2nd channel data port
UART_2CTL:  EQU    063h         ; 2nd channel control port
