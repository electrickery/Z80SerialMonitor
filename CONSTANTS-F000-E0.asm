...
UART_1DAT:  EQU    0E0h         ; 1st channel data port
UART_1CTL:  EQU    0E2h         ; 1st channel control port
UART_2DAT:  EQU    0E1h         ; 2nd channel data port
UART_2CTL:  EQU    0E3h         ; 2nd channel control port
